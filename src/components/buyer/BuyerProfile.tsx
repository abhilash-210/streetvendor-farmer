...
import { User, Camera, Save, Edit, Trash2, MapPin, Phone } from 'lucide-react';
...
const BuyerProfile: React.FC<BuyerProfileProps> = ({ user }) => {
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage your buyer profile and delivery information</p>
        </div>
        ...
        <div className="p-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-6 mb-8">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600">Buyer • {formData.gender || 'Gender Not Set'}</p>
          ...
          <div className="mt-8 p-4 bg-blue-50 rounded-lg">
            ...
            <p className="text-sm text-blue-800">
              Please ensure your delivery address is complete and accurate. This information will be used for order delivery and is required to place orders.
            </p>
          </div>
